...
<head>
	...
	<meta name="author" content="Peneh">
				...
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						<div class="col-3">
							...
							<a href="#" class="logo m-0 float-start text-white"><img src="images/Logo-white.svg" alt="Logo"></a>
						</div>
						<div class="col-8 text-center">
							<ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
								...
								<li><a href="#kvitel">Kvitel</a></li>
								<li><a href="#pictures">Pictures</a></li>
								<!-- <li class="active y-font"><a>מעדני השבת</a> </li> -->
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 text-left">
					...
					<p data-aos="fade-up" class=" mb-5 text-white lead text-white-50">Partner with Madanei Hashabbos, and share the tremendous zechus of bringing food packages to needy families!</p>
					<p data-aos="fade-up"  data-aos-delay="100">
						<a href="https://donary.com/1758" class="btn btn-primary me-4 d-inline-flex align-items-center"> <span class="icon-attach_money me-2"></span><span>Donate Now</span></a> 
				...
				<div class="col-lg-5">
					<form action="https://donary.com/1758" class="bg-white p-5 rounded donation-form" data-aos="fade-up">
						<h3 class="y-font">כאפט א זכות</h3>
						<div class="form-field mb-3">
							<label for="amount-1" class="amount js-amount" data-value="50.00">
								<input type="radio" id="amount-1" name="radio-amount" checked="true">
								<span class="y-font">זכות בשר
									למשפחה</span>
							</label>

							<label for="amount-2" class="amount js-amount" data-value="70.00">
								<input type="radio" id="amount-2" name="radio-amount">
								<span class="y-font">זכות דגים
									למשפחה</span>
							</label>
							<label for="amount-3" class="amount js-amount" data-value="120.00">
								<input type="radio" id="amount-3" name="radio-amount" >
								<span class="y-font">זכות שבת
									פעקל</span>
							</label>
							<label for="amount-4" class="amount js-amount" data-value="1800.00">
								<input type="radio" id="amount-4" name="radio-amount">
								<span class="y-font">פרנס
									לשבוע</span>
							</label>
						...
						<div class="field-icon">
							<span>$</span>
							<input type="text" placeholder="0.00" class="form-control px-4" name="donate-value" value="50.00">
						</div>
						<!-- form -->
						<!-- <div class="form-field mb-3">
		...
		<div class="container">
			<div class="row mb-5 align-items-center justify-content-between">
				<div class="col-lg-5" data-aos="fade-up" data-aos-delay="0">
					...
					<p>Most Yiden in America are blessed with
						wealth; the average refrigerator and
						freezer are stocked with more food than
						our brothers in Israel see in months. This
						is not only true for those who are truly
						poverty-stricken in Israel, but it is also a
						sad reality for “average” families blessed
						with many children who are working hard
						to get by on an income so stretched it
						can’t possibly cover more than the basics
						and barely provides adequate food for an
						entire family. And while such families can
						get by – but barely, עניות is felt in every
						corner.</p>
				</div>
				...
				<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
					<blockquote>
						Your
generous donation will allow for true
simchas Shabbos.
					</blockquote>
				</div>
			</div>
			<div class="row justify-content-between">
				<div class="col-lg-5 pe-lg-5" data-aos="fade-up" data-aos-delay="200">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-mission" role="tabpanel" aria-labelledby="pills-mission-tab">
							...
							<p>Madanei Hashabbos, named after the holy
								Reb Mordchele from Nadvorna zy”u, who
								himself gave out tremendous amounts of
								tzedaka to needy families, plays a critical
								role in today’s Heimish homes in Isreal for
								those, who despite their best efforts, only
								manage to make Shabbos because of the
								actions of this organization</p>
							<p class="mt-5">
								<a href="https://donary.com/1758" class="btn btn-primary me-4">Donate Now</a>
						...
						<div class="tab-pane fade" id="pills-values" role="tabpanel" aria-labelledby="pills-values-tab">
							...
							<p>Madanei Hashabbos is under the
								leadership of Hagaon Hamkubel Rav
								Moshe Frish shlita, who painstakingly
								oversees all the organization’s activities
								and accounts, making sure every penny
								is utilized to the maximum. At the same
								time, Rav Frish also makes it a point to
								deliver Shabbos packages himself to
								needy families.</p>
							<p class="mt-5">
								<a href="https://donary.com/1758" class="btn btn-primary me-4">Take Part</a>
								<!--<a href="#" class="link-more">Learn More <span class="icon-chevron-right"></span></a>
							</p> -->
						</div>
						<div class="tab-pane fade" id="pills-history" role="tabpanel" aria-labelledby="pills-history-tab">
							...
							<p>Due to the life-saving efforts of Madanei
								Hashabbos, children can really enjoy full
								Shabbos meals with meat and fish. This
								worthy organization gives out weekly
								Shabbos packages, and has distributed
								vast quantities of fish and meat over
								the last year. Madanei Hashabbos
								understands that despite the tremendous
								cost of these foods, they are the most
								critical to supply lekovod Shabbos to feed
								hungry children the staples of a regular
								Shabbos seudah.</p>
							<p class="mt-5">
								<a href="https://donary.com/1758" class="btn btn-primary me-4">Be a Sponsor</a>
								<!-- <a href="#" class="link-more">Learn More <span class="icon-chevron-right"></span></a> -->
							</p>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<div class="overlap-imgs">
						...
						<img src="images/img_v_7-min.jpg" alt="Image" class="img-fluid rounded" data-aos="fade-u" data-aos="200">
					</div>
				</div>		
			</div>		
		</div>		
	...
	<div id="kvitel"  class="section flip-section secondary-bg" style="background-image: url('images/tzion.jpg'); background-position: center center">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<span class="subheading-white mb-3 text-white y-font" data-aos="fade-up">קוויטעל</span>
					<h3 class="mb-4 heading text-white" data-aos="fade-up">Send a Kvitel to The Tzion of Reb Mordchela for $120</h3>
					 <a href="https://donary.com/1785?donation_amount=120" class="btn btn-outline-white" data-aos="fade-up" data-aos-delay="200">Do it Now</a>
				</div>		
			</div>		
		</div>		
	</div>
	...
	<div id="pictures" class="section sec-instagram pb-0">
		<div class="container mb-5">
			<div class="row align-items-center">
				<div class="col-lg-3" data-aos="fade-up">
					<span class="subheading mb-3">Pictures</span>
					<!-- <h2 class="heading">This is real</h2> -->
				</div>
				<div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
					<p>
						Partner with Madanei Hashabbos, and
						share the tremendous zechus of bringing
						food packages to needy families! Your
						generous donation will allow for true
						simchas Shabbos and the ability to enjoy
						the Shabbos suedah together as a family,
						dining purely <b>l’kovod Shabbos kodesh!</b></p>
				</div>
			</div>
		</div>
		...
		<div class="instagram-slider-wrap" data-aos="fade-up" data-aos-delay="200">
			<div class="instagram-slider" id="instagram-slider">
				...
				<div class="item">
					<a class="instagram-item">
						<img src="images/img_v_10-min.jpg" alt="Image" class="img-fluid">		
					</a>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3">
					<div class="widget">
						...
						<ul class="list-unstyled float-left links">
							...
							<li><a href="https://donary.com/1758">Donate Now</a></li>
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3">
					<div class="widget">
						<h3>Zelle</h3>
						<ul class="list-unstyled float-left links">
							<li style="color: white;">Send Zelle to MadaneiHashabos@gmail.com</li>
							<li style="color: white;">Tax ID 88-3956737</li>
						</ul>
					</div> <!-- /.widget -->
				</div> 
				...
				<div class="col-6 col-sm-6 col-md-6 col-lg-3">
					<div class="widget">
						...
						<ul class="list-unstyled links mb-4">
							<li style="color: white;">185 Spencer St Brooklyn NY 11205</li>
							<li ><a href="tel:7187858858">718-785-8858</a></li>
							<li><a href="mailto:MadaneiHashabos@gmail.com">MadaneiHashabos@gmail.com</a></li>
						</ul>
			...
			<div class="row mt-5">
				<div class="col-12 text-center">
					<p class="copyright">Copyright &copy;Madanei Hashabos <script>document.write(new Date().getFullYear());</script>. All Rights Reserved. 
					</p>
				</div>
			</div>
		</div> <!-- /.container -->
